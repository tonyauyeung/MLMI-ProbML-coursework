...
def LDA(A, B, K, alpha, gamma):
    ...
    topic_posteriors = []
    topic_posteriors.append(skd.copy())
    swks = []
    word_entropys = [entropy(swk + gamma)]
    ...
    for iter in tqdm(range(num_gibbs_iters)):
        ...
        topic_posteriors.append(skd.copy())
        word_entropys.append(entropy(swk + gamma))
    ...
    return perplexity, swk, topic_posteriors, word_entropys
